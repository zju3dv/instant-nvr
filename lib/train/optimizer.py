...
def make_optimizer(cfg, net, lr=None, weight_decay=None):
    ...
    for key, value in net.named_parameters():
        ...
        if 'data' in key:
            ...
            params += [{"params": [value], "lr": lr * cfg.mlp_weight_decay, "weight_decay": weight_decay}]

    if 'adam' in cfg.train.optim:
        optimizer = _optimizer_factory[cfg.train.optim](params, lr, weight_decay=weight_decay, eps=cfg.train.eps)
    else:
